...
const { UnexpectedError } = require('../../helpers/errors');
...
class Database {
    constructor(config) {
        ...
        const uri = `${this._host}:${this._port}/${this._name}`;
        this._client = new MongoClient(uri, this._options);
    }
    ...
    async connect() {
        try {
            ...
            console.log(`Connected to [${this._name}] database.`);
